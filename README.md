...
- **Change Ports** - Modify listening/connecting ports without reinstalling (supports both BitSwap and Classic configs)
...
- **OS:** Ubuntu or Debian (for optimization; tunnel works on any Linux)
- **Access:** Root
